...
alert("Your keyword has been submitted successfully.");
</script>
...
<div id="content-wrap" class="clear" >
   ...
   <div id="content">
	...
	<form id="Register" action="profile.php" method="post" runat="vdaemon" disablebuttons="all">
      	...
      	if($count < 5)
      	echo '<a href="addkeywords.php">Add More Keywords...</a>';
      	
      	echo '<br/><br/>';
      	
      	if($count > 0)
      	echo '<a href="delkeywords.php">Delete Keywords...</a>';
      	
      	echo '<br/>
        <br/>';
        
      	echo '<button type="submit"  class="control" name="formSubmit" value="submit">Back</button>&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
      &nbsp;&nbsp;&nbsp;&nbsp';
